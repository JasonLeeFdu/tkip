...
%     fprintf('hnm: %d/%d, ', opts.batch_neg, opts.batchSize_hnm*opts.batchAcc_hnm) ;
    ...
    % the batch is composed of opts.batch_pos POS and img_hneg of
    % opts.batch_pos NEG
    ...
    % backprop, and the original output,derivative DZDY,one is the output
    % init dzdy
    ...
    % gradient step -- make use of dzdw
