...
for idxVideo=4:7:length(videosList) %% Here to do the paralell things
=======
for idxVideo=7:7:length(videosList) %% Here to do the paralell things
>>>>>>> b010e60f596766967c158c4f8df798bdd1e376d2
    %% get the imgSet
