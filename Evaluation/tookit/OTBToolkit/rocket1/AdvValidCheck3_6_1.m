...
overWrite = false;
resPathBase = fullfile('/home/winston/workSpace/PycharmProjects/tracking/TrackingGuidedInterpolation/Evaluation/results/ComparativeTest','BothRects_Choose2Center');
...
<<<<<<< HEAD
for idxVideo=[54,62]%5:6:length(videosList) %% Here to do the paralell things
=======
for idxVideo=[86,94]%3:6:length(videosList) %% Here to do the paralell things
>>>>>>> 15a9bbed66a2af0eaa53c8db76da7cce1440bd1b
    %% get the imgSet
    ...
    for idxTrk=1:numTrk     %For every tracker
        ...
        str0 = ['[resAdv ,InterpBboxAdv,MDEGArr,th,fpsAdv] = run_' t.name '_' 'ADV3_6_1' '(imgSet,init_rect,' num2str(BEST_TH) ');'];
        eval(str0);                       
        results = {}; 
        res = struct;
